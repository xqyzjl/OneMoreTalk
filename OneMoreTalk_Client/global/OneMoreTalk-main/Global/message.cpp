...
QString Message::toString() const{
    ...
    return strSenderID+MSG_SPLIT+strReceiverID+MSG_SPLIT+strDatetime+MSG_SPLIT+MSG_DATA_SPLIT+messageData;
}
...
QStringList Message::deCode() const{
    QStringList res = messageData.split(GlobalData::MSG_DATA_SPLIT());
//    qDebug() << messageData;
    res.pop_front();
//    qDebug() << res[0];
